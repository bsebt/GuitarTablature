				...
				// bars
				{
					...
					// characters
					{
						...
						// room for the bar line
						{
							...
							// + rowPos + " Bar: " + barPos);
							while (arrayChar == ' ') // TO DO do this check when
							// we read in data,
							// empty space is
							...
							if (noSpaceAvailable) {
								...
								if (i - barSpacing > 0) {
									...
									// cancelBarDraw = true; //Don't draw a bar
									// line if this is at the end, we have
									// already done that
									...
									// characters before this section
							{
										...
										// before
								{
									...
									// "Repeat for # times"
									{
										if (chars.get(barPos)[rowPos + 1][colPos] == '|') // There
										// was
										// a
										// number,
										// but
